...
| 도구 | 진입 파일 | 권한 제어 | 상태 |
|---|---|---|---|
| Claude Code | `CLAUDE.md` | `.claude/settings.local.json` | ✅ 기본 |
| Gemini CLI | `GEMINI.md` (심볼릭) | Gemini 설정 | 🔸 선택 적용 |
| OpenAI Codex | `AGENTS.md` (심볼릭) | Codex 설정 | 🔸 선택 적용 |

다중 도구 동시 사용 가능. 모든 도구가 **동일한 4계층 규칙**을 따른다.
